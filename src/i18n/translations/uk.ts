...
export const ukrainianTranslations: Record<NodeEciesStringKey, string> = {
  ...
  [NodeEciesStringKey.Error_Member_MissingMemberName]: "Обов'язкове поле: ім'я учасника",
  [NodeEciesStringKey.Error_Member_InvalidMemberNameWhitespace]: "Ім'я учасника не може містити провідні або кінцеві пробіли",
  [NodeEciesStringKey.Error_Member_NoWallet]: 'Немає доступного гаманця',
  [NodeEciesStringKey.Error_Member_WalletAlreadyLoaded]: 'Гаманець вже завантажено',
  [NodeEciesStringKey.Error_Member_InvalidMnemonic]: 'Неправильна мнемонічна фраза',
  [NodeEciesStringKey.Error_Member_MissingPrivateKey]: 'Відсутній приватний ключ',
  [NodeEciesStringKey.Error_Member_MissingEncryptionData]: 'Відсутні дані шифрування',
  [NodeEciesStringKey.Error_Member_EncryptionDataTooLarge]: 'Дані шифрування занадто великі',
  [NodeEciesStringKey.Error_Member_MissingEmail]: "Обов'язкове поле: адреса електронної пошти",
  [NodeEciesStringKey.Error_Member_InvalidEmailWhitespace]: 'Адреса електронної пошти не може містити провідні або кінцеві пробіли',
  ...
  [NodeEciesStringKey.Error_InvalidAESKeyLength]: 'Ключ AES повинен бути 16, 24 або 32 байти',
  [NodeEciesStringKey.Error_CannotEncryptEmptyData]: 'Неможливо зашифрувати null або невизначені дані',
  [NodeEciesStringKey.Error_CannotDecryptEmptyData]: 'Неможливо розшифрувати null або невизначені дані',
  [NodeEciesStringKey.Error_InvalidIVLength]: 'IV повинен бути 16 байтів',
  [NodeEciesStringKey.Error_MessageTooLarge]: 'Повідомлення перевищує максимальний розмір 2ГБ',
  [NodeEciesStringKey.Error_EncryptedSizeExceedsExpected]: 'Розмір зашифрованих даних перевищує очікуваний максимум',
  ...
  [NodeEciesStringKey.Error_Builder_ECIESServiceMustBeSetBeforeGeneratingMnemonic]: 'ECIESService повинен бути встановлений перед генерацією мнемоніки',
  [NodeEciesStringKey.Error_Builder_ECIESServiceIsRequired]: "ECIESService є обов'язковим",
  [NodeEciesStringKey.Error_Builder_TypeNameAndEmailAreRequired]: "Тип, ім'я та електронна пошта є обов'язковими",
  [NodeEciesStringKey.Error_Stream_InvalidPublicKeyLength]: 'Недійсний публічний ключ: повинен бути 33 (стиснутий) або 65 (нестиснутий) байтів',
  [NodeEciesStringKey.Error_Stream_EncryptionCancelled]: 'Шифрування скасовано',
  [NodeEciesStringKey.Error_Stream_BufferOverflow]: 'Переповнення буфера: блок джерела перевищує максимальний розмір',
  [NodeEciesStringKey.Error_Stream_AtLeastOneRecipientRequired]: "Потрібен щонайменше один отримувач",
  [NodeEciesStringKey.Error_Stream_MaxRecipientsExceeded]: 'Підтримується максимум 65535 отримувачів',
  [NodeEciesStringKey.Error_Stream_InvalidRecipientPublicKeyLength]: 'Недійсний публічний ключ отримувача: повинен бути 33 (стиснутий) або 65 (нестиснутий) байтів',
  [NodeEciesStringKey.Error_Stream_InvalidRecipientIdLength]: 'Недійсний ID отримувача: повинен бути 32 байти',
  [NodeEciesStringKey.Error_Stream_InvalidPrivateKeyLength]: 'Недійсний приватний ключ: повинен бути 32 байти',
  [NodeEciesStringKey.Error_Stream_DecryptionCancelled]: 'Розшифрування скасовано',
  [NodeEciesStringKey.Error_Stream_ChunkSequenceError]: 'Помилка послідовності фрагментів',
