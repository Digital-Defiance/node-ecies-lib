...
export const NodeEciesStringKey = createI18nStringKeys(NodeEciesComponentId, {
  Error_LengthError_LengthIsInvalidType:
    'error_length_error_length_is_invalid_type',

  // Member errors
  Error_Member_MissingMemberName: 'error_member_missing_member_name',
  Error_Member_InvalidMemberNameWhitespace:
    'error_member_invalid_member_name_whitespace',
  ...
  Error_MessageLengthExceedsMaximumAllowedSize:
    'error_messageLengthExceedsMaximumAllowedSize',
  Error_InvalidEncryptionTypeOrNumberOfRecipients:
    'error_invalidEncryptionTypeOrNumberOfRecipients',
  Error_EncryptedDataLengthMismatch: 'error_encryptedDataLengthMismatch',
  Error_EphemeralPublicKeyLengthMismatch:
    'error_ephemeralPublicKeyLengthMismatch',
  ...
  Error_BufferIsTooShortToReadFullLengthValue:
    'error_bufferIsTooShortToReadFullLengthValue',
  Error_LengthExceedsMaximumSafeInteger:
    'error_lengthExceedsMaximumSafeInteger',
  Error_BufferIsTooShortForDeclaredDataLength:
    'error_bufferIsTooShortForDeclaredDataLength',
  ...
  Error_Builder_ECIESServiceMustBeSetBeforeGeneratingMnemonic:
    'error_builder_ecies_service_must_be_set_before_generating_mnemonic',
  Error_Builder_ECIESServiceIsRequired:
    'error_builder_ecies_service_is_required',
  Error_Builder_TypeNameAndEmailAreRequired:
    'error_builder_type_name_and_email_are_required',
  ...
  Error_Stream_AtLeastOneRecipientRequired:
    'error_stream_at_least_one_recipient_required',
  Error_Stream_MaxRecipientsExceeded: 'error_stream_max_recipients_exceeded',
  Error_Stream_InvalidRecipientPublicKeyLength:
    'error_stream_invalid_recipient_public_key_length',
  Error_Stream_InvalidRecipientIdLength:
    'error_stream_invalid_recipient_id_length',
  Error_Stream_InvalidPrivateKeyLength:
    'error_stream_invalid_private_key_length',
  ...
  // Invariant errors
  Error_Invariant_ConfigurationValidationFailedTemplate:
    'error_invariant_configuration_validation_failed_template',
  Error_Invariant_NodeRecipientIdConsistency_FailedTemplate:
    'error_invariant_node_recipient_id_consistency_failed_template',
  Error_Invariant_MemberIdLengthMismatchTemplate:
    'error_invariant_member_id_length_mismatch_template',
  Error_Invariant_EciesMultipleRecipientIdSizeMismatchTemplate:
    'error_invariant_ecies_multiple_recipient_id_size_mismatch_template',
  Error_Invariant_EncryptionRecipientIdSizeMismatchTemplate:
    'error_invariant_encryption_recipient_id_size_mismatch_template',
} as const);
